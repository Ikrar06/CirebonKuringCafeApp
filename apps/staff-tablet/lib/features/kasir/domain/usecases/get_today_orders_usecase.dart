...
class GetTodayOrdersUseCase implements UseCase<List<OrderWithPaymentEntity>, NoParams> {
  final KasirRepository repository;

  GetTodayOrdersUseCase(this.repository);

  @override
  Future<Either<Failure, List<OrderWithPaymentEntity>>> call(NoParams params) async {
    return await repository.getTodayOrders();
  }
}
