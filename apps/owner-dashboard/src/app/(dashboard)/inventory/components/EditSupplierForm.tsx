...
export default function EditSupplierForm({ supplierId, onClose, onSuccess }: EditSupplierFormProps) {
  ...
  const loadSupplier = async () => {
    try {
      ...
      setFormData({
        ...
        delivery_rating: data.delivery_rating || 0,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ submit: error.message || 'Failed to update supplier. Please try again.' })
    } finally {
