-- =====================================================
-- FINAL CLEANUP RECIPES TABLE DEPENDENCIES
-- Purpose: Final safe cleanup of all recipes references
-- =====================================================
...
SELECT
    ...
    calculate_menu_item_ingredient_cost(mi.id) as cost,
    check_menu_item_availability(mi.id) as available
FROM menu_items mi
WHERE EXISTS (
...
COMMENT ON FUNCTION calculate_menu_item_ingredient_cost(UUID) IS 'Calculates ingredient cost for menu item';
